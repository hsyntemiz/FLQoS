...
class RestQoSAPI(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj ")
        # logger configure
    ...
    def handler_datapath(self, ev):
        if ev.enter:
            ...
            #self.logger.info("----rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr")
        else:
            ##QoSController.unregist_ofs(ev.dp)
            self.logger.info("%s----XXXXXXXXXXrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",ev.dp)
...
class QoSOfsList(dict):
    ...
    #OFSw cagiriyorum dp_id kontrol ediyorum var mi diye. return format: {dpid: self[dpid]}
...
class QoSController(ControllerBase):
    ...
    def regist_ofs(dp, CONF):
        ...
        try:
            #### ONEMLIIIIIIIIIIIIII
            f_ofs = QoS(dp, CONF) #f_ofs bir dp icin CONF larla QoS object yaratiyor
            f_ofs.set_default_flow() # default flow ekliyor
    ...
    def set_queue(self, req, switchid, **_kwargs):
        ...
        self._LOGGER.debug("....############# QoS Queue ekledik!!!!!!%s yyyy %s ",req, switchid)
        #self.logger.info("....############# QoS Queue ekledik!!!!!!>>>>>>>> ")
        return self._access_switch(req, switchid, VLANID_NONE,
                                   'set_queue', None)
    ...
    def set_qos(self, req, switchid, **_kwargs):
        logging.debug("....TTTTTTTTKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK..>>>>>>>> %s yyyy %s ",req, switchid)
        return self._access_switch(req, switchid, VLANID_NONE,
    ...
    def _access_switch(self, req, switchid, vlan_id, func, waiters):
        try:
            ...
            #logging.debug(".....ACCESS_SWITCH#1_KKKKKKKKKKKKKKKKKKKKKKKKKKKK..>>>>>>>> %s ## ", rest)
        ...
        for f_ofs in dps.values():
            ...
            #logging.debug(".....ACCESS_SWITCH#1a_KKKKKKK..>>>>>>>> %s -- %s## ", function,dps)
            try:
                if waiters is not None:
                    msg = function(rest, vid, waiters)
                else:
                    #Burada def set_queue(self, rest, vlan_id) function una gidiyor
                    #Butun olayi burasi hallediyor
                    msg = function(rest, vid)
                    #logging.debug(".....ACCESS_SWITCH#1b_KKKKKKK..>>>>>>>> %s ## ", msg)
        ...
        #logging.debug(".....ACCESS_SWITCH#2_KKKKKKKKKKKKKKKKKKKKKKKKKKKK..>>>>>>>> %s ## ", body)
        #success gibi seyler return ediyor..EXec eden birsey yok..goruntu basmaca return vs
...
class QoS(object):
    ...
    def set_queue(self, rest, vlan_id):
        #logging.debug(".....XXKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK..>>>>>>>> %s ", rest)
